...
if (isiOS) {
  iosCamYOff = maxDim * -4.5;      // camera DOWN (more negative = lower)
  iosCamZOff = maxDim * -0.2;     //closer to TV (negative = closer)
  iosTargetYOff = maxDim * +0.07;   // aim UP (more positive = higher)
}
